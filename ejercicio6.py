...
'''
Se va a realizar un diccionario por compresion en el cual las llaves son los números odiosos menores a 50 y el valor es una tupla de dos elementos: su representación en binario y su representación en
